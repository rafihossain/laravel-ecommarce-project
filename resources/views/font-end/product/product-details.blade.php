						...
						<div class="col-md-9 single-grid">
							<div clas="single-top">
								...
								<div class="single-right simpleCart_shelfItem">
									...
									<div class="women">
										<input type="submit" name="btn" value="Add To Cart" data-text="Add To Cart" class="my-cart-b item_add">
									</div>
									{{ Form::close() }}
								...
								<div class="col-md-4 product-grid">
									<div id="owl-demo" class="owl-carousel">
										...
										<div class="item">
											<div class="recent-grids">
												<div class="recent-left">
													<a href="single.html"><img class="img-responsive " src="{{ asset('/') }}/font-end/images/r4.jpg" alt=""></a>	
												</div>
												<div class="recent-right">
													<h6 class="best2"><a href="single.html">Lorem ipsum dolor </a></h6>
													<div class="block">
											...
											<div class="recent-grids">
												<div class="recent-left">
													<a href="single.html"><img class="img-responsive " src="{{ asset('/') }}/font-end/images/r5.jpg" alt=""></a>	
												</div>
												<div class="recent-right">
													<h6 class="best2"><a href="single.html">Duis aute irure </a></h6>
													<div class="block">
									...
									<img class="img-responsive " src="{{ asset('/') }}/font-end/images/woo2.jpg" alt="">
								</div>
											...
											<div id="myTabContent" class="tab-content">
												<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
													<div class="descr">
														...
														<p class="quote">Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit
													...
													<div class="descr">
														<div class="reviews-top">
															<div class="reviews-left">
																<img src="{{ asset('/') }}/font-end/images/men3.jpg" alt=" " class="img-responsive">
															</div>
							...
							<div class="col-md-3 arrival-grid simpleCart_shelfItem">
								<div class="grid-arr">
									<div  class="grid-arrival">
										<figure>		
											<a href="{{ route('product-details', ['id'=>$relatedProduct->id,'name'=>$relatedProduct->product_name]) }}">
												<div class="grid-img">
